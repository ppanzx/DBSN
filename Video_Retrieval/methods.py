...
def main():
    ...
    ##########################################TODO##################################################
    logger.info("Globally-Corrected (GC)")
    t_hubness, v_hubness = Inverted_Softmax(sims, t_tau=0.02, v_tau=0.02)
    sims2rank(sims-v_hubness, sims-t_hubness)

    logger.info(" Cross-Domain Similarity Local Scaling (CSLS)")
    t_hubness, v_hubness = Inverted_Softmax(sims, t_tau=0.02, v_tau=0.02)
    sims2rank(sims-v_hubness, sims-t_hubness)
